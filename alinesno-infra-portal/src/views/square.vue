        ...
        <main class="waterfall-container">
            ...
            <article class="card" v-for="(item , index) in cards" :key="index" :class="['card', item.type]">
                ...
                <div class="card-content" v-if="item.type === 'article'">
                    <h2>{{ item.title }}</h2>
                    <img src="https://portal.infra.linesno.com/product/aip_all_product_01.jpg" alt="Sunset Image"
                        class="card-image">
                    <p>
                        {{ item.content }}
                    </p>
                ...
                <div class="card-content" v-if="item.type === 'music'">
                    <h2>{{ item.title }}</h2>
                    <img src="https://portal.infra.linesno.com/product/aip_all_product_01.jpg" alt="Sunset Image" class="card-image">
                    <audio controls>
                ...
                <div class="card-content" v-if="item.type === 'image'">
                    <h2>{{ item.title }}</h2>
                    <img :src="item.image" alt="Sunset Image" 
                    class="card-image">
                 </div>
...
const cards = ref([
{
    type: 'article',
    user: {
      avatar: 'https://staticok.oss-cn-hangzhou.aliyuncs.com/avatar-share/thumbnail-20240313-033056.webp',
      username: '鲍勃·布朗',
      description: '作家与博主'
    },
    title: '讲故事的艺术',
    content: '故事讲述是一门古老的艺术，它能够激发人们的想象力并传递知识。一个好的故事可以跨越时空，触动人心。',
    image: 'https://portal.infra.linesno.com/product/aip_all_product_01.jpg',
    answers: 10
  },
  {
    type: 'music',
    user: {
      avatar: 'https://staticok.oss-cn-hangzhou.aliyuncs.com/avatar-share/thumbnail-6046836d-7766-4bfd-a93d-85fd52d2b0e4.webp',
      username: '约翰·多伊',
  ...
  },
  {
    type: 'video',
    user: {
      avatar: 'https://staticok.oss-cn-hangzhou.aliyuncs.com/avatar-share/thumbnail-56d48d94-e821-45e4-8592-37981ac1a483.webp',
      username: '简·史密斯',
      description: '视频博主与旅行爱好者'
    },
    title: '探索大自然',
    videoSrc: 'https://www.w3school.com.cn/i/movie.mp4'
  },
  {
    type: 'image',
    user: {
      avatar: 'https://staticok.oss-cn-hangzhou.aliyuncs.com/avatar-share/thumbnail-fbff7e50-1460-4834-83f5-9235821105ca.webp',
      username: '爱丽丝·约翰逊',
