...
/**
 * 处理与IpbannedEntity相关的请求的Controller。
 * 继承自BaseController类并实现IIpbannedService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class IpbannedController extends BaseController<IpbannedEntity, IIpbannedService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(IpbannedController.class);

    @Autowired
    private IIpbannedService service;

    /**
     * 获取IpbannedEntity的DataTables数据。
     *
    ...
    @Override
    public IIpbannedService getFeign() {
        return this.service;
    }
}