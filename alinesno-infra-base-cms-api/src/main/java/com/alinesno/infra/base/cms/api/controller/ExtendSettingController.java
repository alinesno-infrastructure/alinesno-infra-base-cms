...
/**
 * 处理与ExtendSettingEntity相关的请求的Controller。
 * 继承自BaseController类并实现IExtendSettingService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class ExtendSettingController extends BaseController<ExtendSettingEntity, IExtendSettingService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(ExtendSettingController.class);

    @Autowired
    private IExtendSettingService service;

    /**
     * 获取ExtendSettingEntity的DataTables数据。
     *
    ...
    @Override
    public IExtendSettingService getFeign() {
        return this.service;
    }
}