...
/**
 * 处理与LinkageEntity相关的请求的Controller。
 * 继承自BaseController类并实现ILinkageService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class LinkageController extends BaseController<LinkageEntity, ILinkageService> {
    ...
    @Autowired
    private ILinkageService service;

    /**
     * 获取LinkageEntity的DataTables数据。
     *
    ...
    @Override
    public ILinkageService getFeign() {
        return this.service;
    }
}