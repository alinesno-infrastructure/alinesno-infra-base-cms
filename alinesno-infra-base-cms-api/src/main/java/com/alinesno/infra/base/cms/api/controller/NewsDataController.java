...
/**
 * 处理与NewsDataEntity相关的请求的Controller。
 * 继承自BaseController类并实现INewsDataService接口。
 * 
 * @author luoxiaodong
 * @version 1.0.0
 */
...
public class NewsDataController extends BaseController<NewsDataEntity, INewsDataService> {
    ...
    @Autowired
    private INewsDataService service;

    /**
     * 获取NewsDataEntity的DataTables数据。
     *
    ...
    @Override
    public INewsDataService getFeign() {
        return this.service;
    }
}