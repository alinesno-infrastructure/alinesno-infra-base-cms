...
/**
 * 处理与CollectionHistoryEntity相关的请求的Controller。
 * 继承自BaseController类并实现ICollectionHistoryService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class CollectionHistoryController extends BaseController<CollectionHistoryEntity, ICollectionHistoryService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(CollectionHistoryController.class);

    @Autowired
    private ICollectionHistoryService service;

    /**
     * 获取CollectionHistoryEntity的DataTables数据。
     *
    ...
    @Override
    public ICollectionHistoryService getFeign() {
        return this.service;
    }
}