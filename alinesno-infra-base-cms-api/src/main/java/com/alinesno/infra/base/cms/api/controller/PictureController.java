...
/**
 * 处理与PictureEntity相关的请求的Controller。
 * 继承自BaseController类并实现IPictureService接口。
 * 
 * @author luoxiaodong
 * @version 1.0.0
 */
...
@RequestMapping("/api/infra/simple/crm/picture")
public class PictureController extends BaseController<PictureEntity, IPictureService> {
    ...
    @Override
    public IPictureService getFeign() {
        return this.service;
    }
}