...
/**
 * 处理与区块权限相关的请求的Controller。
 * 继承自BaseController类并实现IBlockPrivService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class BlockPrivController extends BaseController<BlockPrivEntity, IBlockPrivService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(BlockPrivController.class);

    @Autowired
    private IBlockPrivService service;
    ...
    @Override
    public IBlockPrivService getFeign() {
        return this.service;
    }
}