...
/**
 * 处理与TestDataEntity相关的请求的Controller。
 * 继承自BaseController类并实现ITestDataService接口。
 * 
 * @author luoxiaodong
 * @version 1.0.0
 */
...
public class TestDataController extends BaseController<TestDataEntity, ITestDataService> {
    ...
    @Autowired
    private ITestDataService service;

    /**
     * 获取TestDataEntity的DataTables数据。
     *
    ...
    @Override
    public ITestDataService getFeign() {
        return this.service;
    }
}