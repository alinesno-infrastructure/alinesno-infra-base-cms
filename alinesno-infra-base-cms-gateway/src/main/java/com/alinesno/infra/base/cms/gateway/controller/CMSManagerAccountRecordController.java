...
/**
 * 处理与CMSManagerAccountRecordEntity相关的请求的Controller。
 * 继承自BaseController类并实现ICMSManagerAccountRecordService接口。
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
...
public class CMSManagerAccountRecordController extends BaseController<CMSManagerAccountRecordEntity, ICMSManagerAccountRecordService> {
    ...
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(CMSManagerAccountRecordController.class);

    @Autowired
    private ICMSManagerAccountRecordService service;

    /**
     * 获取CMSManagerAccountRecordEntity的DataTables数据。
     *
    ...
    @Override
    public ICMSManagerAccountRecordService getFeign() {
        return this.service;
    }
}