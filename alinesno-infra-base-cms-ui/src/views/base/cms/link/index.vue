<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="700px" append-to-body>
      <el-form ref="LinkFormRef" :model="form" :rules="rules" label-width="80px">
          <el-col :span="24">
            <el-form-item label="菜单图标" prop="LinkIcons">
              <el-popover
                  ...
                  @show="showSelectIcon">
                <template #reference>
                  <el-input v-model="form.LinkIcons" placeholder="点击选择图标" @click="showSelectIcon" v-click-outside="hideSelectIcon" readonly>
                    <template #prefix>
                      <svg-icon
                          v-if="form.LinkIcons"
                          :icon-class="form.LinkIcons"
...
function getList() {
  loading.value = true;
  listLink(proxy.addDateRange(queryParams.value, dateRange.value)).then(response => {
